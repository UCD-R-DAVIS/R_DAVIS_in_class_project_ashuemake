...
# genealize this where we change country and year range
...
#and the name of a country (e.g. "Afghanistan"), and plots a time series of the c
#ountry’s population. The return value from the function should be a ggplot object. 
#Note: It is often easier to modify existing code than to start from scratch. 
#To start out with one plot for a particular country, figured out what you need 
#to change for each iteration (these will be your arguments), and then wrap it in a function.
